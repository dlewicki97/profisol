<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <?php $links = ['Ikony' => 'header_icons', 'Opis' => 'header_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon fas fa-header tx-20"></i>
        ...
        <?php $links = ['Slider' => 'slider', 'Pasek pod sliderem' => 'under_slider']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <?php $links = ['O nas' => 'about', 'O nas opisy' => 'about_descriptions', 'Statystyki' => 'statistics', 'Statystyki tło' => 'statistics_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <?php $links = ['Oferta' => 'offers', 'Opisy' => 'offers_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon fas fa-concierge-bell tx-20"></i>
        ...
        <?php $links = ['Realizacje' => 'realizations_categories', 'Opisy' => 'realizations_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon fas fa-project-diagram tx-20"></i>
        ...
        <?php $links = ['Aktualności' => 'news', 'Opisy' => 'news_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon fas fa-newspaper tx-20"></i>
        ...
        <?php $links = ['Praca' => 'jobs', 'Opisy' => 'jobs_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon fas fa-tools tx-20"></i>
        ...
        <?php $links = ['Lista' => 'hours', 'Opis' => 'hours_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon fas fa-clock tx-20"></i>
            <span class="menu-item-label">Godziny otwarcia</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
        ...
        <?php $links = ['Opisy' => 'contact_descriptions', 'Social Media' => 'social_icons']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <?php $links = ['Opisy' => 'footer_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon fas fa-shoe-prints tx-20"></i>
