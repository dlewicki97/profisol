                ...
                <div class="col-md-8">
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            ...
                            border-bottom-left-radius: 3px;" type="text" class="form-control p-2" id="getOrder<?php echo $value->id; ?>"
                            name="menu_order" placeholder="Kolejność" onchange="changeOrder(<?php echo $value->id; ?>)"
    ...
    <script type="text/javascript">
          function changeOrder(id) {
            ...
            $.ajax({
              type: "post",
              url: "<?php echo base_url(); ?>panel/settings/menu_order",
              data: {
                id: id,
