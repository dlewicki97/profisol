                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <div class="form-group  bd-t-0-force ">
                            <label class="form-control-label">Strzałka w prawo:</label>
                    ...
                    <div class="col-md-12">
                        <div id="photoViewer_1" class="form-group  bd-b-0-force bd-t-0-force ">
                            <label class="form-control-label">Tekst alternatywny Strzałki w prawo:</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group bd-t-0-force ">
                            <label class="form-control-label">Strzałka w lewo:</label>
                    ...
                    <div class="col-md-12">
                        <div id="photoViewer_2" class="form-group bd-t-0-force">
                            <label class="form-control-label">Tekst alternatywny Strzałki w lewo:</label>
