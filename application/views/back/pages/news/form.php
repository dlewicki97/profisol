            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-b-0-force ">
                                <label class="form-control-label">Opis seo (j. angielski):</label>
                                <textarea class="summernote" name="en_meta_description"><?php echo @$value->en_meta_description; ?></textarea>
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
                    <div class="row">
