            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    <div class="row"> 
                        ...
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Tekst przycisku 1:</label>
                        ...
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-l-0-force bd-t-0-force ">
                                ...
                                <textarea class="summernote" name="link1"><?php echo @$value->link1; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Tekst przycisku 2:</label>
                        ...
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-l-0-force bd-t-0-force ">
                                ...
                                <textarea class="summernote" name="link2"><?php echo @$value->link2; ?></textarea>
                            </div>
                        </div>
                    </div> 
                    <div class="row"> 
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Tekst przycisku 1 (j. angielski):</label>
                                <textarea class="summernote" name="en_button_name1"><?php echo @$value->en_button_name1; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-l-0-force bd-t-0-force ">
                                <label class="form-control-label">Link przycisku 1 (j. angielski):</label>
                                <textarea class="summernote" name="en_link1"><?php echo @$value->en_link1; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Tekst przycisku 2 (j. angielski):</label>
                                <textarea class="summernote" name="en_button_name2"><?php echo @$value->en_button_name2; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-l-0-force bd-t-0-force ">
                                <label class="form-control-label">Link przycisku 2 (j. angielski):</label>
                                <textarea class="summernote" name="en_link2"><?php echo @$value->en_link2; ?></textarea>
                            </div>
                        </div>
                    </div> 
                    <div class="row"> 
