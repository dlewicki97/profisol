            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    <div class="row"> 
                        <div class="col-md-12 pr-0">
                            <div class="form-group ">
                                <label class="form-control-label">Napis na banerze na stronie głównej: <span class="tx-danger">*</span></label>
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">WYMAGANIA:</label>
                                <textarea class="summernote" name="requirements"><?php echo @$value->requirements; ?></textarea>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row"> 
                        <div class="col-md-12 pr-0">
                            <div class="form-group ">
                                <label class="form-control-label">Napis na banerze na stronie głównej (j. angielski): <span class="tx-danger">*</span></label>
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">WYMAGANIA (j. angielski):</label>
                                <textarea class="summernote" name="en_requirements"><?php echo @$value->en_requirements; ?></textarea>
                            </div>
                        </div>
                    </div> 
