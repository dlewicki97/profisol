          ...
          <table id="datatable1" class="table display responsive nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle"><?php echo $value->work_place; ?></td>
                <td class="text-right">
                  <a href="<?php echo base_url(); ?>panel/jobs_requirements/list/<?php echo $value->id; ?>" class="btn btn-sm btn-secondary"><i class="fas fa-list mg-r-10"></i> Wymagania</a>
